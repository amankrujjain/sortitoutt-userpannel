           ...
           <div className="px-6 pt-4">
             <div className="flex items-center justify-between">
               <div className="flex items-center">
                 ...
                 <p className="text-bold md:text2xl text-base pl-3 text-gray-800">Sort It Outt</p>
               </div>
                 ...
                 <li className="text-gray-700 pt-8">
                   <div className="flex items-center">
                     <div className="flex items-center">
                       ...
                       <p className="text-gray-700 ml-3 text-lg">Orders</p>
                     </div>
                   ...
                   {product ? (
                     <div>
                       <ul className="my-3">
                         <Link to={'/create-order'} className="text-sm hover:text-indigo-500 py-2 px-6">Create</Link>
                         <Link  to={''} className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6">View Orders</Link>
                         <Link to={''} className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6">Finished Orders</Link>
                       </ul>
                     </div>
                   ) : (
                     ""
               ...
               <Link to={'#'}>
                 <li className="text-gray-800 pt-8">
                   <div className="flex items-center">
                     ...
                     <p className="text-gray-800 ml-3 text-lg">Stats</p>
                   </div>
                 </li>
               </Link >
               <Link to={'#'}>
             ...
             <div className="border-t border-gray-300">
               <div className="w-full flex items-center justify-between px-6 pt-1">
                 <div className="flex items-center">
                   ...
                   <p className=" text-gray-800 text-base leading-4 ml-2">Raj Verma</p>
                 </div>
                 <ul className="flex">
       ...
       <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
         <div className="flex items-center">
           <div className="mr-10 flex items-center">
             ...
             <h3 className="text-base text-gray-800 font-bold tracking-normal leading-tight ml-3 hidden lg:block">Sort It Outt</h3>
           </div>
           <ul className="pr-32 xl:flex hidden items-center h-full">
             <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-indigo-700 tracking-normal"><Link to={'/'}>Dashboard </Link></li>
             <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal relative">
               {product ? (
                 <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                   <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal"><Link to={'/create-order'}>Create</Link></li>
                   <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">View Orders</li>
                   <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Finished Orders</li>
                 </ul>
               ) : (
                 ""
               )}
             ...
             <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mr-10 tracking-normal">Order Status</li>
           ...
           <div className="h-full flex items-center">
             ...
             <div className="w-full h-full flex">
               ...
               <div aria-haspopup="true" className="cursor-pointer w-full flex items-center justify-end relative" onClick={() => setProfile(!profile)}>
                 ...
                 <p className="text-gray-800 text-sm ml-2">Raj Verma</p>
               </div>
             </div>
           </div>
         </div>
